<?php
    ...
    $sql.= "where status_chamado in ('Fechado', 'Aguardando resposta') and t.idSolicitante =".$_SESSION['id']." order by status_chamado desc ";
    ...
    if($resultado){
        while($registro = mysqli_fetch_array($resultado, MYSQLI_ASSOC)){
            ...
            echo '<a href="../Views/historico-chamado.php?id='.$id.'" class="btn_conversa">';
